...
<template>
  ...
  <div class="flex flex-col min-h-screen dark:bg-night">
    <AppHeader />
...
html,
body {
  @apply bg-gray-100 text-gray-900 dark:text-gray-300;
...
select {
  @apply bg-white border rounded-md font-medium border-gray-300 flex-1 text-sm p-1.5 pr-12 pl-4 text-gray-500 dark:text-gray-300 relative inline-flex items-center hover:bg-gray-50 focus:z-20 py-2 px-4 appearance-none;
...
input[type='radio'] + label {
  @apply cursor-pointer text-gray-600 dark:text-gray-300 hover:text-primary;
}
