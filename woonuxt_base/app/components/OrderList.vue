...
<template>
  <div class="bg-white rounded-lg flex shadow min-h-[250px] p-4 md:p-12 justify-center items-center">
    ...
    <div v-else-if="orders && orders.length === 0" class="min-h-[250px] flex items-center justify-center text-gray-500 dark:text-gray-300 text-lg">No orders found.</div>
...
tbody tr {
  @apply text-sm text-gray-500 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-400;
}
