...
<template>
  <header class="sticky top-0 z-[99] bg-white dark:bg-black shadow-sm shadow-light-500">
    <div class="container flex items-center justify-between py-4">
      <div class="flex items-center">
        <MenuTrigger class="lg:hidden" />
        <Logo class="md:w-[160px]" />
      </div>
      <MainMenu class="items-center hidden gap-6 text-sm text-black-500 lg:flex lg:px-4" />
