  ...
  <div>
    ...
    <div v-if="isOpen" class="mt-3 text-sm grid gap-3">
      ...
      <div class="cursor-pointer flex gap-2 items-center">
        ...
        <label class="flex items-center text-gray-300" for="star-four">
      ...
      <div class="cursor-pointer flex gap-2 items-center">
        ...
        <label class="flex items-center text-gray-300" for="star-three">
      ...
      <div class="cursor-pointer flex gap-2 items-center">
        ...
        <label class="flex items-center text-gray-300" for="star-two">
      ...
      <div class="cursor-pointer flex gap-2 items-center">
        ...
        <label class="flex items-center text-gray-300" for="star-one">
