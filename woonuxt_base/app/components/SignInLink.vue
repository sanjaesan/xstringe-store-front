...
<template>
  <NuxtLink to="/my-account" :title="linkTitle" class="hidden sm:inline-flex aspect-square items-center signin-icons">
    <Transition name="pop-in" mode="out-in">
      ...
      <Icon v-else name="ion:person-outline" size="22" class="bg-black hover:bg-primary border border-transparent" />
    </Transition>
  </NuxtLink>
</template>
...
.signin-icons {
  .iconify {
    @apply dark:text-gray-300 hover:text-crimson;
  }
}
</style>
