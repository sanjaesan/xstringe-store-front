...
<template>
  <form class="relative product-search-icons items-center flex-1 -space-x-px rounded-md shadow-sm" @submit.prevent="setSearchQuery(searchQuery)">
    ...
    <input
      ...
      class="z-0 inline-flex items-center w-full p-2 pl-10 text-sm text-gray-500 border-0 rounded-md shadow-inner outline-none bg-night-shade shadow-black-200" />
    <span
      v-if="searchQuery"
