...
<template>
  <div>
    <h4 v-if="reviews.edges.length" class="font-semibold text-2xl text-gray-400">{{ $t('messages.shop.customerReviews') }}</h4>
    <h4 v-else class="font-semibold text-2xl text-gray-400">{{ $t('messages.shop.noReviews') }}</h4>
    ...
    <div class="mt-10 text-xl mb-2 text-gray-400">Share your thoughts</div>
