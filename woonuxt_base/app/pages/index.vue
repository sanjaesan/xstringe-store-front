...
<template>
  <main>
    ...
    <section class="container grid gap-6 my-24 md:grid-cols-2 lg:grid-cols-4">
      <div class="flex items-center gap-4 p-8 bg-night-shade rounded-lg">
        <img src="/icons/box.svg" width="60" height="60" alt="Free Shipping" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold text-crimson">Free Shipping</h3>
          <p class="text-sm text-maroon">Free shipping on order over €50</p>
        </div>
      </div>
      <div class="flex items-center gap-4 p-8 bg-night-shade rounded-lg">
        <img src="/icons/moneyback.svg" width="60" height="60" alt="Money Back" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold text-crimson">Peace of Mind</h3>
          <p class="text-sm text-maroon">30 days money back guarantee</p>
        </div>
      </div>
      <div class="flex items-center gap-4 p-8 bg-night-shade rounded-lg">
        <img src="/icons/secure.svg" width="60" height="60" alt="Secure Payment" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold text-crimson">100% Payment Secure</h3>
          <p class="text-sm text-maroon">Your payment are safe with us.</p>
        </div>
      </div>
      <div class="flex items-center gap-4 p-8 bg-night-shade rounded-lg">
        <img src="/icons/support.svg" width="60" height="60" alt="Support 24/7" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold text-crimson">Support 24/7</h3>
          <p class="text-sm text-maroon">24/7 Online support</p>
        </div>
      </div>
    </section>
