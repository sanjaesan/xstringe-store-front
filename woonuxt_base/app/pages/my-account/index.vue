      ...
      <div v-else class="flex flex-col items-start justify-between w-full lg:gap-12 mb-24 lg:flex-row">
        <div class="mt-2 lg:sticky top-16 w-full lg:max-w-[260px]">
          <section class="my-8 flex gap-4 items-start justify-center w-full">
            ...
            <button class="flex text-gray-700 dark:text-gray-300 items-center flex-col p-2 px-4 rounded-lg hover:bg-white hover:text-red-700 lg:hidden" @click="logoutUser">
          ...
          <hr class="my-8" />
          <nav class="flex text-gray-700 dark:text-gray-300 lg:grid flex-wrap w-full gap-1.5 my-8 min-w-[240px] lg:w-auto items-start">
          ...
          <template class="hidden lg:block">
            <hr class="my-8" />
            <button class="flex text-gray-700 dark:text-gray-300 items-center gap-4 p-2 px-4 w-full rounded-lg hover:bg-white hover:text-red-700" @click="logoutUser">
